    ...
    return (
        <View className="flex-row items-center px-4 py-3 bg-white border-t border-gray-200 pb-10">
            <TouchableOpacity className="items-center mr-6" onPress={onChat}>
                ...
                <Text className="text-xs text-gray-700 mt-1">Chat ngay</Text>
            </TouchableOpacity>
            <TouchableOpacity className="items-center mr-6" onPress={onAddToCart}>
                <Ionicons name="cart-outline" size={24} color="black" />
                <Text className="text-xs text-gray-700 mt-1">Thêm Vào Giỏ hàng</Text>
            </TouchableOpacity>
            <TouchableOpacity className="flex-1 bg-red-500 py-3 rounded items-center" onPress={onBuyNow}>
